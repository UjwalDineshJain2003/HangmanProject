...
im=ImageTk.PhotoImage(Image.open(f"{userpath}/images/hangman_stage_0.jpeg"))
im2=ImageTk.PhotoImage(Image.open(f'{userpath}/images/hangman_stage_1.jpeg'))
im3=ImageTk.PhotoImage(Image.open(f"{userpath}/images/hangman_stage_2.jpeg"))
im4=ImageTk.PhotoImage(Image.open(f'{userpath}/images/hangman_stage_3.jpeg'))
im5=ImageTk.PhotoImage(Image.open(f'{userpath}/images/hangman_stage_4.jpeg'))
im6=ImageTk.PhotoImage(Image.open(f'{userpath}/images/hangman_stage_5.jpeg'))
im7=ImageTk.PhotoImage(Image.open(f'{userpath}/images/hangman_stage_6.jpeg'))
